var enemyPlane1, enemyPlane2, enemyPlane3, enemyPlane4, enemyPlane5, enemyPlane6, enemyPlane7
...
class Level2 {
    ...
    setup() {
        ...
        enemyPlane6 = createSprite(300, 350, 50, 50)
        enemyPlane6.addImage(enemyImg)
        enemyPlane6.scale = 0.17

        enemyPlane7 = createSprite(windowWidth - 800, 350, 50, 50)
        enemyPlane7.addImage(enemyImg)
        enemyPlane7.scale = 0.17
    ...
    draw() {
        if (gameState === "start") {
            ...
            enemyPlane6.visible = false;
            enemyPlane7.visible = false;
            bgMusic.play()
        }
        if (gameState === "play") {
            ...
            enemyPlane6.visible = true;
            enemyPlane7.visible = true;
    ...
    destroyEnemy() {
        ...
        else if (pBulletGroup.isTouching(enemyPlane6)) {
            enemyPlane6.destroy()
            score += 10
        }
        else if (pBulletGroup.isTouching(enemyPlane7)) {
            enemyPlane7.destroy()
            score += 10
        }
    }
        ...
        if (World.frameCount % 10 === 0) {
            ...
            switch (rand) {
                ...
                case 5: eBullet.x = enemyPlane5.x;
                    break;
                case 6: eBullet.x = enemyPlane6.x;
                    break;
                case 7: eBullet.x = enemyPlane7.x;
                    break;
                default: break;
            }
