...
var level1, userInterface, pause, pauseImage

function preload() {
  backImg = loadImage("images/back.png")
  playerImg = loadImage("images/player.png")
  pbulletImg = loadImage("images/pBullet.png")
  ...
  pauseImage = loadImage("images/blast1.png")
}
...
function setup() {
  ...
  e = createSprite(windowWidth / 7 - 100, windowHeight / 2 - 200, 50, 50)
  e.addImage(enemyImg)
  e.scale = 0.19
  e2 = createSprite(windowWidth - 100, windowHeight / 2 - 200, 50, 50)
  e2.addImage(enemyImg)
  e2.scale = 0.19
  e3 = createSprite(windowWidth - 100, windowHeight / 2 + 50, 50, 50)
  e3.addImage(enemyImg)
  e3.scale = 0.19
  e4 = createSprite(windowWidth / 7 - 100, windowHeight / 2 + 50, 50, 50)
  e4.addImage(enemyImg)
  e4.scale = 0.19
  p = createSprite(windowWidth / 2, windowHeight - 100, 50, 50);
